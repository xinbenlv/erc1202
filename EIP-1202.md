...
Note: we are still open to have co-author to collaborate, in particular, we are looking for co-authors who are experienced in application-layer standard design, or voting system application developer. 
...
- 2018-07-22: (@xinbenlv)Moved official discussion thread from [github issue](https://github.com/ethereum/EIPs/issues/1202) to [ethereum-magicians](https://ethereum-magicians.org/t/erc-1202-voting-standard-official-discussion-thread/670) - moved back pending community clarification.
- 2018-07-23: (@xinbenlv)
